...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp  83.2885
  #define DEFAULT_bedKi  15.8947
  #define DEFAULT_bedKd 209.9545
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.95, 79.99, 800.94, 137.8157438 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 400, 100 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -57.5, -9.5, -1.24 }
...
#define XY_PROBE_FEEDRATE (210*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (350)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (125)
...
#define HOMING_FEEDRATE_MM_M { (132*60), (132*60), (5*60) }
...
//#define SKEW_CORRECTION
  ...
  //#define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_DIAG_AC 140.22
    #define XZ_DIAG_BD 140.38
    #define YZ_DIAG_AC 140.5
    #define YZ_DIAG_BD 140.5
    #define YZ_SIDE_AD 99.81
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 180, Y_MAX_POS, 20 }
